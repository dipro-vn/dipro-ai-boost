...
> Mã C1-C3/M1-M2/M4 dùng chung với self-check của `/gen-tcs`. M3 (Boundary Completeness) chỉ có ở `/review-tcs` — cần đối chiếu sâu constraint trong AC nên không chạy tự động lúc sinh TC.
