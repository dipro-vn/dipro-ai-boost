...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::explorer::delete_explorer_file,
            commands::explorer::rename_explorer_entry,
            commands::explorer::import_explorer_paths,
            commands::explorer::write_explorer_file,
