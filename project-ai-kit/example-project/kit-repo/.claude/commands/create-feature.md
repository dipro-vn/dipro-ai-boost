---
description: Chạy toàn bộ BMAD pipeline để tạo ra 1 feature hoàn chỉnh — từ SPEC đến code đã qua QA/QC. Có 1 gate bắt buộc trước khi động vào code. Dùng: /create-feature <feature> [mô tả] | /create-feature <feature> build
---
