...
description: Suy ra hành vi responsive đầy đủ khi design chỉ có một hoặc hai breakpoint — xác định điểm gãy layout, cách sắp xếp lại, ẩn hiện phần tử, hành vi của bảng và navigation trên mobile. Dùng khi design thiếu bản mobile hoặc tablet.
---
...
- Giả định cần xác nhận: specific assumptions regarding breakpoints that need confirmation from the designer.
```
