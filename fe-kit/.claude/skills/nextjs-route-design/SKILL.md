...
description: Thiết kế cấu trúc route và folder cho feature Next.js — dynamic segment [id], catch-all [...slug], route group (group), parallel route @slot, intercepting route. Dùng khi lên cấu trúc URL cho feature mới.
---
...
2. Dùng `[...slug]` cho catch-all route khi cần nhiều segment, `[[...slug]]` cho optional segment chỉ khi thật sự cần.
