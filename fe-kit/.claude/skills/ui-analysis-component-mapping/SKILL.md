...
description: Chuyển design thành cây component code — nhận diện phần lặp lại, đặt ranh giới component, xác định props và biến thể, đối chiếu với component sẵn có trong codebase. Dùng khi bắt đầu hiện thực hóa một màn hình từ thiết kế.
---
...
1. Tách design thành cây component theo phân cấp rõ ràng về giao diện và chức năng.
