...
description: Tạo và chạy Prisma migration — migrate dev ở local, migrate deploy ở production, đặt tên migration có nghĩa, tách thay đổi phá data thành nhiều bước có backfill. Dùng khi thay đổi Prisma schema.
---
...
4. Đổi tên/đổi type không phá data: thêm cột mới → backfill → bỏ cột cũ (ít nhất 3 bước).
