...
description: Checklist review PR tổng quát — đảm bảo code đúng, rõ ràng, an toàn, có test tương ứng. Dùng làm điểm khởi đầu cho mọi lượt review PR hoặc changeset trước khi merge.
---
...
1. Đúng: code phải thực hiện các yêu cầu đã nêu trong ticket, bao gồm các edge case và xử lý lỗi.
